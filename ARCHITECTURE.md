...
- 3D meshes use fixed 4-sample spacing and a local neighborhood, rather than a multi-resolution planetary terrain renderer. Very fine brush details are clearer in 2D.
